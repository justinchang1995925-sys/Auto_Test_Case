...
所有正式交付件**独立分开**呈现，不得混在一起：**除测试点思维导图外**（需求清单、测试用例、用例附表、追溯表、专项测试用例、专项数据采集、质量审计）一律以 **Excel** 独立成表；**测试点思维导图**单独交付为**可直接导入飞书在线思维导图的缩进大纲文件（Markdown 大纲 / OPML）**。详见 `SKILL.md` 「交付物规范」。
